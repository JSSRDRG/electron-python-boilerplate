...
def error ( text:str = "") :
    ...
    '''
    ipc.send('{"obj":"console","func":"error","args":"' + text + '"}')

def info ( text:str = "") :
    '''
        Informative logging of information.
    '''
    ipc.send('{"obj":"console","func":"info","args":"' + text + '"}')

def log ( text:str = "") :
    '''
        For general output of logging information.
    '''
    ipc.send('{"obj":"console","func":"log","args":"' + text + '"}')

def warn ( text:str = "") :
    '''
        Outputs a warning message.
    '''
    ipc.send('{"obj":"console","func":"warn","args":"' + text + '"}')
